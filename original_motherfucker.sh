...
pause '___________--3'
# run it
sudo bazel-bin/inception/download_and_preprocess_flowers "${FLOWERS_DATA_DIR}"
pause '___________--4'
...
sudo curl -O http://download.tensorflow.org/models/image/imagenet/inception-v3-2016-03-01.tar.gz
pause '___________--8'

sudo tar xzf inception-v3-2016-03-01.tar.gz
pause '___________--9'
